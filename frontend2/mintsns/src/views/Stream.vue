<template>
  <div>
    <header id="header" role="banner">
      ...
      <img class="user-icon" src="{{user.iconUrlMedium}}" />

      <div class="notification-button">0</div>

      <div class="navigation">
        <div #target class="navigation-rotate">
          <div class="navigation-item" *ngFor="let stream of viewStreams">
            {{ stream.name }}
          </div>
        </div>
        ...
        <div class="navigation-arrow-right" (click)="onClickNextStream()">
          >
        </div>
      </div>
    </header>
